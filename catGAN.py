...
parser.add_argument('--input_folder', default='/home/vineet/Downloads/Extra/catGAN/data', help='input folder')
parser.add_argument('--output_folder', default='/home/vineet/Downloads/Extra/catGAN/Output', help='output folder')
parser.add_argument('--G_load', default='//home/vineet/Downloads/Extra/catGAN/Model/gen', help='Full path to Generator model to load (ex: /home/output_folder/run-5/models/G_epoch_11.pth)')
parser.add_argument('--D_load', default='/home/vineet/Downloads/Extra/catGAN/Model/dis', help='Full path to Discriminator model to load (ex: /home/output_folder/run-5/models/D_epoch_11.pth)')
